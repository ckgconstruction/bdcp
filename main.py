...
def train_meta(args):
    ...
    logger.info("=====Loading Corpus: " + valid_data_path + "=====")
    valid_corpus = Corpus(
        logger,
        valid_data_path,
        args.bert_model,
    ...
    if args.debug:
        ...
        logger.info("=====Loading Corpus: " + train_data_path + "=====")
        train_corpus = Corpus(
            logger,
            train_data_path,
            args.bert_model,
        ...
        if not args.ignore_eval_test:
            ...
            logger.info("=====Loading Corpus: " + test_data_path + "=====")
            test_corpus = Corpus(
                logger,
                test_data_path,
                args.bert_model,
...
def convert_bpe(args):
    def convert_base(train_mode: str):
        ...
        logger.info("=====Loading Corpus: " + data_path + "=====")
        corpus = Corpus(
            logger,
            data_path,
            args.bert_model,
...
def parse_args():
    ...
    # dataset settings
    parser.add_argument("--data_path", type=str, default="data/episode-data")
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    args.bert_model = './models/bert-base-uncased/'
    ...
    if args.test_only:
        top_dir = "logs/models-{}-{}-{}".format(args.N, args.K, args.mode)

        args.model_dir = "{}-innerSteps_{}-lrInner_{}-lrMeta_{}-maxSteps_{}-seed_{}{}".format(
            time_tag,
        ...
        args.result_dir = "{}-innerSteps_{}-lrInner_{}-lrMeta_{}-maxSteps_{}-seed_{}{}".format(
            time_tag,
